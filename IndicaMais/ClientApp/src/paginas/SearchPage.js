...
function SearchPage() {
    ...
    async function pesquisar() {
        ...
        var baixa = modoPesquisa.transacao === true ? (document.getElementById("baixa").value === '-' ? '' : document.getElementById("baixa").value) : "";
                    ...
                    <div className={style.pesquisa}>
                        ...
                        {modoPesquisa.parceiro === true ?
                            <div>
                                <select id="fechou">
                                    <option value="-">Todos</option>
                                    <option selected value="false">Não fechou</option>
                        ...
                        {modoPesquisa.parceiro === true ?
                            <div>
                                <select id="foiIndicado">
                                    ...
                                    <option selected value="true">Foi indicado</option>
                                </select>
                            </div>
                            : ""}
                        ...
                        {modoPesquisa.transacao === true ?
                            <div>
                                <select id="baixa">
                                    ...
                                    <option selected value="false">Em aberto</option>
