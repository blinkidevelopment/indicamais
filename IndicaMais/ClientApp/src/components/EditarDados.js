...
import style from './EditarDados.module.scss';
    ...
    async function editar() {
        ...
        if (nome === "") {
            ...
            if (resposta) {
                ...
                setMensagem("Opa, parece que alguém já está usando esse número de celular. Tente novamente");
            }
        }
    }
        ...
        <>
            ...
            <ModalConfirmacao
                ...
                mensagemConfirmacao="Você tem certeza de que quer excluir sua conta? O seu saldo de crédito será zerado e você não poderá entrar na conta novamente, 
                    nem receberá saldo caso os parceiros que você indicou fechem contrato"
